...
// import BaseUI from "components/deckgl/BaseUI";
//
...
//         <p>
//           All displayed data is sourced from CORDIS (Community Research and
//           Development Information Service). The main unit of analysis is
//           research institutions with their associated funded projects.
//         </p>
//         <p>
//           Each country is extruded based on the total funding received by all
//           institutions in that country for projects in the selected year.
//         </p>
//         <p>
//           To see the <b> individual projects and institutions </b> please refer
//           to
//           <a
...
//
//       <section>
//         <h3 className="font-semibold text-gray-800">Topic Classification</h3>
//         <p>
//           Each project in Cordis is classified using EuroSciVoc topics which has
//           a 6 level hierarchy. The Top Right Trend Tab maps them in the
//           following way:
//         </p>
...
//         </h3>
//         <p>The funding amounts shown in the Topic Trends panel are based on:</p>
//         <ul className="ml-6 list-disc">
//           <li>Total EC contribution to projects associated with each topic</li>
//           <li>
...
//           Note: This approach provides a broad view of EC funding priorities but
//           may overrepresent funding for topics in multi-topic projects.
//         </p>
//       </section>
//
//       <section>
//         <h3 className="font-semibold text-gray-800">Field Filters</h3>
//         <p>The field filter at the bottom applies keyword-based criteria:</p>
//         <ul className="ml-6 list-disc">
//           <li>
...
//           </li>
//           <li>
//             <strong>Cultural Heritage:</strong> Projects with &quot;(cultural
//             AND heritage)&quot; in title or objective
//           </li>
//           <li>
//             <strong>Digital Heritage:</strong> Projects with &quot;(digital AND
//             heritage)&quot; in title or objective
//           </li>
//         </ul>
//         <p className="text-sm italic">
